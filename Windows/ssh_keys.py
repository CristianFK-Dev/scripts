...
def display_public_key(key_name="id_rsa"):
    """
...
if __name__ == "__main__":
    ...
    while True:
        key_file_name = input("Introduce el nombre de archivo para la clave SSH (Sin extensión)." 
        ...
        if key_file_name:
            ...
            while True:
                ...
                if not os.path.exists(key_path):
                    print(f"Usando nombre de archivo por defecto: {key_file_name}")
                    break
                aux += 1
            break
